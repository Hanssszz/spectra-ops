...
import AssignGuardDialog from '@/components/sites/AssignGuardDialog';
...
export default function SitesDirectoryPage() {
  ...
  const handleAssignClick = (site: Site) => {
                  ...
                  <tr key={site.id} className="hover:bg-secondary/30 transition-colors group">
                    ...
                    <td className="px-6 py-4 text-right">
                      <div className="flex items-center justify-end gap-1.5">
                        <button 
                          onClick={() => handleAssignClick(site)}
                          className="flex items-center gap-1 bg-primary/10 hover:bg-primary/20 text-primary px-3 py-1.5 rounded-lg text-xs font-semibold border border-primary/20 transition-all shrink-0"
                        >
                          <Plus className="h-3.5 w-3.5" /> Deploy Guard
                        </button>
                        <button className="text-muted-foreground hover:text-foreground p-1.5 rounded hover:bg-secondary transition-colors shrink-0">
